...
var PackageUtilities = function () {
  ...
  _createClass(PackageUtilities, null, [{
    ...
    */
    ...
    key: "filterNonDependentPackages",
    value: function filterNonDependentPackages(packages, scope) {
      var filteredGraph = PackageUtilities.getPackageGraph(packages);
      ...
      return packages.filter(function (pkg) {
        return ~dependentPackages.indexOf(pkg.name);
      });
    }
  }]);
